...
Func MF2Collect()
   ...
   If NOT @error Then
	  Send("{right down}")
	  $yellowPixel = PixelSearch(147, 119, 175, 1278 0xFFdd44, 10) ; (Collect 6)
	  While @error
		 sleep(100)
		 $yellowPixel = PixelSearch(147, 119, 175, 1278 0xFFdd44, 10) ; (Collect 6)
	  WEnd
...
#comments-end
   ...
   If NOT @error Then
	  attack()
	  Send("{left down}")
	  $yellowPixel = PixelSearch(22, 74, 65, 83, 0xFFdd44, 10) ; (Platform 3 Endb4)
	  While @error
		 teleport("left")
		 sleep(200)
		 attack()
   ...
   $yellowPixel = PixelSearch(24, 74, 107, 83, 0xFFdd44, 10) ; (Platform 3)
   If NOT @error Then
	  $yellowPixel = PixelSearch(22, 74, 44, 83, 0xFFdd44, 10) ; (Platform 3 End)
	  While @error
		 sleep(100)
		 $yellowPixel = PixelSearch(22, 74, 44, 83, 0xFFdd44, 10) ; (Platform 3 End)
		 Send("{left up}")
   ...
   $yellowPixel = PixelSearch(22, 74, 494, 83, 0xFFdd44, 10) ; (Platform 3 End)
   IF NOT @error Then
	  teleport("down")
	  sleep(200)
	  attack()
