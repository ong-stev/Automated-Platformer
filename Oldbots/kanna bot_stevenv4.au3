...
Func MTS4setup()
   ...
   $yellowPixel = PixelSearch(93, 96, 122, 104, 0xFFdd44, 10) ; (Setup#2)
	  IF NOT @error Then
		 teleport("left")
		 sleep(200)
	  EndIf
   ...
   $yellowPixel = PixelSearch(63, 104, 91, 104, 0xFFdd44, 10) ; (Extra#10)
	  IF NOT @error Then
		 Send("{left down}")
		 $yellowPixel = PixelSearch(63, 104, 91, 104, 0xFFdd44, 10) ; (Extra#10)
			While @error
...
#comments-start
   Send("{left down}")
   $yellowPixel = PixelSearch(63, 108, 85, 113, 0xFFdd44, 10) ; (Setup#3)
	  While @error
		 sleep(100)
		 $yellowPixel = PixelSearch(63, 108, 85, 113, 0xFFdd44, 10) ; (Setup#3)
	  WEnd
...
Func MTS4Collect()
   ...
   Send("{left down}")
   attack()
   $yellowPixel = PixelSearch(32, 117, 40, 128, 0xFFdd44, 10) ; (Rectangle 3)
   While @error
	  sleep(100)
	  $yellowPixel = PixelSearch(32, 117, 40, 128, 0xFFdd44, 10) ; (Rectangle 3)
	  WEnd
